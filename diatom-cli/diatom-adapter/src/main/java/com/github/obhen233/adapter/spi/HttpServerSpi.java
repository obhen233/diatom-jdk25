...
/**
 * SPI interface for HTTP server lifecycle management (adapter module).
 *
 ...
 * via {@code META-INF/services/com.github.obhen233.adapter.spi.HttpServerSpi}.</p>
 */
public interface HttpServerSpi {
     ...
     * @param path URL path (e.g., "/worker/v1/health")
